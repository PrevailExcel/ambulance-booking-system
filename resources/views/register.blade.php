...
<head>
    ...
    <title>Register - Ambulance Booking System</title>
        ...
        <div class="row full">
            <div class="col-md-8 col-sm-12 bg-dark bg-theme-2">
                <div class="text-white ps-5mt-3 mt-md-5">
                    <h2>Create an account with us to book ambulances for emergencies</h2>
                    <p><a href="/" class="text-theme">Go Back.</a></p>
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    <form class="my-auto mt-5 pt-5 px-3" method="POST" action="{{ route('register') }}">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-dark bg-theme border-0 px-5 py-2">Create Account</button>
                    </form>
